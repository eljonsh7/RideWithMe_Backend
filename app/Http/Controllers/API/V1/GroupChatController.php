...
use App\Http\Requests\API\V1\Message\Group\RetrieveGroupMembersRequest;
use App\Http\Requests\API\V1\Message\Group\StoreMessageRequest;
use App\Http\Requests\API\V1\Message\Group\SendMessageToGroupRequest;
 ...
 */
    ...
    public function retrieveAllGroupMembers(RetrieveGroupMembersRequest $request, $group)
    {
        $request->validated();
 ...
 * )
 */
    public function sendMessageToGroup(SendMessageToGroupRequest $request, $group)
    {
        $data = $request->validated();
        $user = auth()->user();
