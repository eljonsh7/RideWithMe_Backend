...
use App\Http\Requests\API\V1\Message\DeleteConversationRequest;
use App\Http\Requests\API\V1\Message\GetConversationRequest;
use App\Http\Requests\API\V1\Message\GetConversationsWithMessagesRequest;
use App\Http\Requests\API\V1\Message\MarkConversationAsReadRequest;
...
class ChatController extends Controller
{
     ...
     * )
     */
    public function sendMessage(SendMessageRequest $request, $recipient)
    {
    ...
    public function getConversation(GetConversationRequest $request, $recipient, $type)
    {
        $request->validated();
        $user = auth()->user();
     ...
     * )
     */
    public function getConversationsWithMessages(GetConversationsWithMessagesRequest $request)
    {
        $request->validated();
        $user = auth()->user();
    ...
    public function deleteConversation(DeleteConversationRequest $request, $recipient)
    {
        $request->validated();
        $user = auth()->user();
        $authenticatedUserId = $user->id;
    ...
    public function markConversationAsRead(MarkConversationAsReadRequest $request, $recipient)
    {
        $request->validated();
